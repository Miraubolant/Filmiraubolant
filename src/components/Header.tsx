...
import { Film, Tv, Filter, Calendar, Clock, Monitor, Search, X, Tag, ChevronDown, TrendingUp, Calendar as CalendarIcon, Menu } from 'lucide-react';
...
export function Header({ onSearch, onFilterChange, filters }: HeaderProps) {
  ...
  return (
    <div className="sticky top-16 z-40 bg-[#141414]/95 backdrop-blur-xl border-b border-theme shadow-lg">
